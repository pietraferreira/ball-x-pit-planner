...
// --- EVOLUTIONS (Updated with Flexible Recipes) ---
export const evolutions = [
    { name: "Assassin", recipes: [["Iron", "Ghost"], ["Iron", "Dark"]], desc: "Backstabs deal 30% bonus dmg." },
    { name: "Banished Flame", recipes: [["Dark", "Burn"]], desc: "Darkflame (DOT + Burst on expire)." },
    { name: "Berserk", recipes: [["Charm", "Burn"], ["Charm", "Bleed"]], desc: "Enemies attack adjacent units." },
    { name: "Black Hole", recipes: [["Dark", "Sun"]], desc: "Instantly kills first enemy." },
    { name: "Blizzard", recipes: [["Freeze", "Lightning"], ["Freeze", "Wind"]], desc: "Freezes area for 0.8s." },
    { name: "Bomb", recipes: [["Burn", "Iron"]], desc: "Explodes for 150-300 AOE." },
    { name: "Brimstone", recipes: [["Burn", "Poison"], ["Burn", "Stone"]], desc: "Burn + Poison aura." },
    { name: "Catapult", recipes: [["Stone", "Egg Sac"]], desc: "Launches stone baby balls." },
    { name: "Fireworks", recipes: [["Burn", "Egg Sac"]], desc: "Explodes into burning fireworks." },
    { name: "Flash", recipes: [["Light", "Lightning"]], desc: "Screen-wide damage & blind." },
    { name: "Flicker", recipes: [["Light", "Dark"]], desc: "Screen-wide tick damage." },
    { name: "Freeze Ray", recipes: [["Freeze", "Laser (Horizontal)"], ["Freeze", "Laser (Vertical)"]], desc: "Beam freezes enemies." },
    { name: "Frozen Flame", recipes: [["Burn", "Freeze"]], desc: "Frostburn: DOT + Dmg Amp." },
    { name: "Glacier", recipes: [["Freeze", "Earthquake"], ["Freeze", "Stone"]], desc: "Leaves damaging spikes." },
    { name: "Hemorrhage", recipes: [["Bleed", "Iron"]], desc: "Consumes bleed for % HP dmg." },
    { name: "Holy Laser", recipes: [["Laser (Horizontal)", "Laser (Vertical)"]], desc: "Cross laser damage." },
    { name: "Incubus", recipes: [["Charm", "Dark"]], desc: "Charmed enemies curse others." },
    { name: "Inferno", recipes: [["Burn", "Wind"]], desc: "AOE Burn aura." },
    { name: "Landslide", recipes: [["Stone", "Earthquake"]], desc: "Self-destructing AOE zone." },
    { name: "Laser Beam", recipes: [["Light", "Laser (Horizontal)"], ["Light", "Laser (Vertical)"]], desc: "High dmg beam + Blind." },
    { name: "Laser Cutter", recipes: [["Steel", "Laser (Horizontal)"], ["Steel", "Laser (Vertical)"]], desc: "Constant frontal laser." },
    { name: "Leech", recipes: [["Brood Mother", "Bleed"]], desc: "Leeches apply heavy bleed." },
    { name: "Lightning Rod", recipes: [["Lightning", "Iron"]], desc: "Strikes attached enemies." },
    { name: "Lovestruck", recipes: [["Charm", "Light"], ["Charm", "Lightning"]], desc: "Enemies heal you." },
    { name: "Maggot", recipes: [["Cell", "Brood Mother"]], desc: "Infests enemies, spawns babies." },
    { name: "Magma", recipes: [["Burn", "Earthquake"]], desc: "Leaves lava blobs." },
    { name: "Mosquito King", recipes: [["Vampire", "Brood Mother"]], desc: "Spawns high dmg mosquitoes." },
    { name: "Mosquito Swarm", recipes: [["Vampire", "Egg Sac"]], desc: "Explodes into mosquitoes." },
    { name: "Nosferatu", recipes: [["Vampire Lord", "Mosquito King", "Spider Queen"]], desc: "Spawns bats -> Lords." },
    { name: "Noxious", recipes: [["Wind", "Poison"], ["Wind", "Dark"]], desc: "Passes through, AOE poison." },
    { name: "Nuclear Bomb", recipes: [["Bomb", "Poison"]], desc: "Huge dmg + Radiation." },
    { name: "Overgrowth", recipes: [["Earthquake", "Cell"]], desc: "Stacking burst AOE." },
    { name: "Phantom", recipes: [["Ghost", "Dark"]], desc: "Curses enemies." },
    { 
        name: "Radiation Beam", 
        recipes: [
            ["Laser (Horizontal)", "Poison"], ["Laser (Horizontal)", "Cell"],
            ["Laser (Vertical)", "Poison"], ["Laser (Vertical)", "Cell"]
        ], 
        desc: "Beam applies Radiation." 
    },
    { name: "Sacrifice", recipes: [["Bleed", "Dark"]], desc: "Heavy bleed + Curse." },
    { name: "Sandstorm", recipes: [["Wind", "Earthquake"], ["Wind", "Stone"]], desc: "Storm aura + Blind." },
    { name: "Satan", recipes: [["Incubus", "Succubus"]], desc: "Global Burn + Berserk." },
    { name: "Shotgun", recipes: [["Iron", "Egg Sac"]], desc: "Shoots iron baby balls." },
    { name: "Soul Sucker", recipes: [["Ghost", "Vampire"]], desc: "Saps HP and Attack." },
    { name: "Spider Queen", recipes: [["Brood Mother", "Egg Sac"]], desc: "Spawns Egg Sacs." },
    { name: "Steel", recipes: [["Iron", "Stone"]], desc: "Slow, dmg ramps up." },
    { name: "Storm", recipes: [["Lightning", "Wind"]], desc: "Periodic lightning strikes." },
    { name: "Succubus", recipes: [["Charm", "Vampire"]], desc: "Charm + Heal on hit." },
    { name: "Sun", recipes: [["Light", "Burn"]], desc: "Global Blind + Burn." },
    { name: "Swamp", recipes: [["Poison", "Earthquake"]], desc: "Tar blobs: Slow + Poison." },
    { name: "Vampire Lord", recipes: [["Vampire", "Bleed"], ["Vampire", "Dark"]], desc: "Heals and consumes bleed." },
    { name: "Virus", recipes: [["Poison", "Ghost"], ["Poison", "Cell"]], desc: "Spreading disease." },
    { name: "Voluptuous Egg Sac", recipes: [["Egg Sac", "Cell"]], desc: "Explodes into MORE egg sacs." },
    { name: "Wraith", recipes: [["Freeze", "Ghost"]], desc: "Freezes passed enemies." }
];
